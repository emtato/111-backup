...
class AdventureGameSimulation:
    ...
    def __init__(self, game_data_file: str, initial_location_id: int, commands: list[str]) -> None:
        ...
        first_event = Event(id_num=initial_location_id,
                            description=self._game.get_location().description)
    ...
    def generate_events(self, commands: list[str], current_location: Location) -> None:
        ...
        for command in commands:
            next_loc_id = curr_loc.available_commands[command]
            curr_loc = self._game.get_location(next_loc_id)
            new_event = Event(id_num=curr_loc.id_num,
